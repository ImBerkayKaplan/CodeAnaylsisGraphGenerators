...
public class CallGraphGenerator {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		// Soot classpath
		File directoryPath = new File("exampleProjects");
		String[] projects = directoryPath.list();
		String path = "";
		for (String project : Objects.requireNonNull(projects)) {
			String[] folders = (new File("exampleProjects/" + project)).list();
			List<String> foldersAsList = new ArrayList<String>(Arrays.asList(Objects.requireNonNull(folders)));
			...
			processBuilder.command("cmd.exe", "/c", "graphVisualizationSoftware\\dot.exe -Tpng graphVisualizationSoftware\\g.gv -o graphImages\\" + project + ".png");
